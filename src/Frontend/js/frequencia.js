...
$.ajax({ //Sintax do AJAX Jquery
    url: "https://revirar-projeto4.herokuapp.com/fichafrequenciaselect", // URL definido no endpoint do node(node app_xx.js)
...
function salvarAssFreq() { //Função do botão de salvar chamado pelo onclick do botão dentro do modal do html
    ...
    var settings = { //armazena o endpoint de insert dentro de uma variavel
        "url": "https://revirar-projeto4.herokuapp.com/fichafrequenciainsert",
        "method": "POST",
        "timeout": 0,
        "data": {
            "dataFreq": dataFreq,
...
function deletedoc(id) { // função dentro do modal de confirmar exclusão
        $.ajax({ // ajax com metodos do endpoint
            type: 'POST',
            url: "https://revirar-projeto4.herokuapp.com/fichafrequenciadelete",
...
function editDoacao(id) {
    console.log(id);
    $.ajax({
        url: "https://revirar-projeto4.herokuapp.com/fichafrequenciaselect",
        type: 'GET',
        success: data => {
...
function editVal(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://revirar-projeto4.herokuapp.com/fichafrequenciaupdate',
